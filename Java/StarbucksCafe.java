...
public class StarbucksCafe extends AppCompatActivity {
    ...
    public void alert(final String userId){
        ...
        AlertDialog.Builder builder2 = new AlertDialog.Builder(StarbucksCafe.this);//first alert box
        ...
        builder2.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(!location.equals("Offline")){
                    AlertDialog.Builder builder = new AlertDialog.Builder(StarbucksCafe.this);//second alert box
                    ...
                    builder.setItems(timeW, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            handler.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    NotificationCompat.Builder b = new NotificationCompat.Builder(StarbucksCafe.this);
                                    b.setAutoCancel(true)
                                            ...
                                            .setContentInfo("INFO");
                                    NotificationManager nm = (NotificationManager) StarbucksCafe.this.getSystemService(Context.NOTIFICATION_SERVICE);
                                    nm.notify(1, b.build());
                                }
                            }, timerMili);
